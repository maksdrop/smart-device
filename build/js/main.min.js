...
/* harmony import */ var _modules_about_open__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/about-open */ "./js/modules/about-open.js");
/* harmony import */ var _modules_form_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form-mask */ "./js/modules/form-mask.js");
...
/* harmony import */ var _modules_toggle_text__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/toggle-text */ "./js/modules/toggle-text.js");
/* harmony import */ var _modules_toggle_tabindex__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/toggle-tabindex */ "./js/modules/toggle-tabindex.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_about_open__WEBPACK_IMPORTED_MODULE_3__["default"])();
    Object(_modules_form_mask__WEBPACK_IMPORTED_MODULE_4__["default"])();
    Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_5__["default"])('[data-form]', '[data-parent-name]', '[data-parent-phone]', '[data-name]', '[data-form-phone]', '[data-attribute]');
    Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_5__["default"])('[data-modal-form]', '[data-parent-name]', '[data-parent-phone]', '[data-name]', '[data-form-phone]', '[data-attribute]');
    Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_6__["default"])();
    Object(_modules_toggle_text__WEBPACK_IMPORTED_MODULE_7__["default"])('#intro', '(max-width: 768px)');
    Object(_modules_toggle_text__WEBPACK_IMPORTED_MODULE_7__["default"])('#services', '(max-width: 768px)');
    Object(_modules_toggle_tabindex__WEBPACK_IMPORTED_MODULE_8__["default"])('#sections', '(max-width: 768px)');
    Object(_modules_toggle_tabindex__WEBPACK_IMPORTED_MODULE_8__["default"])('#contacts', '(max-width: 768px)');
  });
});
...
function openBlock() {
  ...
  var descriptions = document.querySelectorAll('[data-indent]');
...
/* harmony default export */ __webpack_exports__["default"] = (openBlock);
...
function showAccordion() {
  ...
  var listAccordion = document.querySelectorAll('[data-accordion-list]');
...
/* harmony default export */ __webpack_exports__["default"] = (useMask);
...
function initValidation(formSelector, parentNameSelector, parentPhoneSelector, nameSelector, phoneSelector, attributed) {
  ...
  var parentName = form.querySelector(parentNameSelector);
  var parentPhone = form.querySelector(parentPhoneSelector);
  var name = form.querySelector(nameSelector);
  var phone = form.querySelector(phoneSelector);
  var lengthParentName = parentName.childNodes.length;
  document.querySelectorAll(attributed).forEach(function (attribute) {
    attribute.removeAttribute('required');
  });
  var createMessage = function createMessage(parentElement, message) {
    var messageElement = document.createElement('div');
    messageElement.style.cssText = "\n      position: absolute;\n      bottom: -19px;\n      font-size: 12px;\n      color: red;\n    ";
    messageElement.textContent = message;
    parentElement.append(messageElement);
  };
  var createCondition = function createCondition(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (initValidation);
...
function scrollElement() {
  var link = document.querySelector('.intro__button');
  link.addEventListener('click', function (e) {
    e.preventDefault();
    var header = document.querySelector('.header').scrollHeight;
    var topOffset = document.querySelector('.questions').getBoundingClientRect().top;
    var offsetPosition = topOffset - header;
    window.scrollBy({
      top: offsetPosition,
      behavior: 'smooth'
    });
...
function showTabindex(selectorElement, viewport) {
  var textElement = document.querySelector(selectorElement);
  var screen = window.matchMedia(viewport);
...
/* harmony default export */ __webpack_exports__["default"] = (showTabindex);
...
/* harmony default export */ __webpack_exports__["default"] = (showNewText);
